...
"https://github.com/notprash/dotfiles
set number 
syntax on
...
" General
set number  " Line numbers set nobackup              " No backup file set noswapfile            " No swap file set expandtab             " Use spaces instead of tabs.
...
nnoremap <silent>gr :BufferLineCyclePrev<CR>
